...
//#include <WiFiLoRa32V2.1Pins.h>

// Define Vext if necessary
//#define Vext 36
...
void setup(void)
{
  // start serial port
  Serial.begin(115200);
//  pinMode(Vext, OUTPUT);    // Vext pin
//  digitalWrite(Vext, LOW);  // Vext ON
  Serial.println("Dallas Temperature IC Control Library Demo");

  Serial.print("Processor Architecture : ");
  #if defined(__ASR_Arduino__)
    Serial.println("ASR Arduino");
  #else
    Serial.println("Unrecognised");
  #endif

  Serial.print("ARDUINO Index : ");
  #if ARDUINO >= 100
    Serial.println(">= 100");
  #else
    Serial.println("< 100");
