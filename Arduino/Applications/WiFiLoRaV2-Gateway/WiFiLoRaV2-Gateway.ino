 ...
 *  8 Oct 2023 v2.2.1 Call statusCheck() on startup
 * 17 Nov 2023 v2.2.2 Remove references to EEPROM_HANDLER (no longer included in PacketHandler library)
 * 
 * 17 Nov 2023
 * Digital Concepts
...
softwareRevision sketchRevision = {2,2,2};
bool softRev = true;
